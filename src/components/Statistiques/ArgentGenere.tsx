...
export default function ArgentGenere() {
      ...
      return (
        <Container maxWidth="xl">
          <Stack spacing={2} marginTop={4} direction="row" justifyContent="space-between">
            ...
            >
              <Typography sx={{ fontSize: "16px", fontWeight: "500" }}>Région</Typography>
            ...
            >
              <Typography sx={{ fontSize: "16px", fontWeight: "500" }}>Département</Typography>
                    ...
                    <Box sx={{
                        ...
                        <div>
                            {selectedFilter === "parRegion" ? (
                              ...
                              selectedFilter==="parTypeDePrestation" && selectedService ?(                              
                              <FormControl
                                    sx={{
                                        width: "327px",
                                        height: "40px",
                    ...
                    >
                        ...
                        <Button
                            sx={{
                                fontSize: "14px",
                                fontWeight: "500",
                                color: selectedFilter === "parTypeDePrestation" ? "primary.main" : "text.secondary",
  ...
  <Box sx={{ display: "flex", gap: "16px", alignItems: "center" }}>
    ...
    <Box
      sx={{
        width: selectedValue ? "200px" : "300px", // Adjust width conditionally
