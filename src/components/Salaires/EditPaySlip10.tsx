...
export default function EditPaySlip10({
  setState,
  row,
  onClose,
}: EditPaySlipProps) {
  ...
  const handleNinethModalOpen = () => {
    setState(9);
  };

  const handleEleventhModalOpen = () => {
    setState(11);
  };
    ...
    <>
      ...
      p: "1.5625rem", // 25px
        ...
        >
          ...
          >
            Mentions Complémentaires et Légales
          </Typography>
          ...
          >
            ...
            <Button
              ...
              onClick={handleEleventhModalOpen}
            >
              Suivant
            </Button>
          </Box>
