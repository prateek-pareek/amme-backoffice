...
>
  ...
  <Typography sx={{ fontSize: "0.875rem", fontWeight: "400", color: "#818EA0" }}>
  ...
  <Tabs
    ...
    sx={{ mt: 3, height: "1.25rem", backgroundColor: "#F6F7F9", padding: "0.25rem" }} // 20px = 1.25rem, 4px = 0.25rem
  >
    <Tab
      label="Informations"
      sx={{
  ...
  <TabPanel value={tabValue} index={0}>
    <Typography variant="subtitle1" sx={{ fontWeight: "600", fontSize: "1.125rem" }}> {/* 18px = 1.125rem */}
      Informations
    </Typography>
    <Box sx={{ mt: 2 ,}}>
      <Typography sx={{ display: "flex", justifyContent: "space-between", }}>
        <strong style={{ fontSize: "0.875rem", fontWeight: "500", color: "#818EA0" ,}}>Prénom:</strong>
        Patrick
      </Typography>
      <Typography sx={{ display: "flex", justifyContent: "space-between" }}>
        <strong style={{ fontSize: "0.875rem", fontWeight: "500", color: "#818EA0" }}>Nom:</strong>
        Lebord
      </Typography>
      <Typography sx={{ display: "flex", justifyContent: "space-between" }}>
        <strong style={{ fontSize: "0.875rem", fontWeight: "500", color: "#818EA0" }}>Adresse mail:</strong>
        lebord.p@yahoo.fr
      </Typography>
      <Typography sx={{ display: "flex", justifyContent: "space-between" }}>
        <strong style={{ fontSize: "0.875rem", fontWeight: "500", color: "#818EA0" }}>Téléphone portable:</strong>
        +33 7 09 23 12 00
      </Typography>
      <Typography sx={{ display: "flex", justifyContent: "space-between" }}>
        <strong style={{ fontSize: "0.875rem", fontWeight: "500", color: "#818EA0" }}>Numéro de sécurité sociale:</strong>
        1 97 00 98 238 923 09
      </Typography>
    </Box>

    <Typography variant="subtitle1" sx={{ mt: 3, fontWeight: "600", fontSize: "1.125rem" }}>
      Retour
    </Typography>
    <Box sx={{ display: "flex", justifyContent: "space-between" }}>
      <Typography variant="subtitle1" sx={{ fontWeight: "400", fontSize: "0.875rem", color: "#818EA0" }}>
        Retour client(e):
      </Typography>
    ...
    <Box sx={{ mt: 2 }}>
      ...
      <Typography sx={{ mt: 1, bgcolor: "#F6F7F9", borderRadius: "0.375rem", padding: "0.375rem", fontWeight: "400", fontSize: "0.875rem" }}>
    ...
    <Box sx={{ mt: 2 }}>
      ...
      <Typography variant="body2" sx={{ mt: 1, bgcolor: "#F6F7F9", borderRadius: "0.375rem", fontWeight: "400", fontSize: "0.875rem" }}>
  ...
  <TabPanel value={tabValue} index={1}>
    <Box sx={{ padding: "2.1875rem" }}> {/* 35px = 2.1875rem */}
      <img
        src={prescription}
        alt=""
        style={{
